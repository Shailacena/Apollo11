...
# 返回值 bool jd_ck
def getToken(sess, wskey):  # 方法 获取 Wskey转换使用的 Token 由 JD_API 返回 这里传递 wskey
    # try:
    ...
    try:
        ...
        return appjmp(sess, wskey, tokenKey)  # 传递 wskey, Tokenkey 执行方法 [appjmp]


# 返回值 bool jd_ck
def appjmp(sess, wskey, tokenKey):  # 方法 传递 wskey & tokenKey
